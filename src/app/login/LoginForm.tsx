          ...
          <div className="w-full max-w-sm flex flex-col items-center" style={{ width: "100%", maxWidth: "384px" }}>
            ...
            {state?.error && (
              <div
                role="alert"
                aria-live="polite"
                className="w-full mb-6 px-4 py-3 bg-red-950/20 border border-red-800/40 text-red-300 text-[13px] font-mono flex items-center gap-2.5 rounded-none"
              >
            ...
            {/* Login Form */}
            <form noValidate action={formAction} className="w-full flex flex-col gap-6">
              <div className="w-full flex flex-col gap-2">
                <label className="text-[12px] tracking-[0.1em] font-bold text-[#c7c8b7] uppercase font-mono" htmlFor="username">
                  IDENTIFICADOR DE ACCESO
                </label>
                <div className="relative w-full">
                  <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#919282] pointer-events-none">badge</span>
                  <input
                    ref={identifierRef}
                    name="identifier"
                    id="username"
              ...
              <div className="flex items-center justify-between w-full">
                <label className="flex items-center group cursor-pointer" htmlFor="rememberMe">
                  <input
                    id="rememberMe"
                    name="rememberMe"
                    type="checkbox"
                ...
                <span className="text-[14px] text-slate-500 opacity-60 cursor-not-allowed" title="Funcionalidad pendiente para una fase posterior">
              ...
              <button
                ...
                className="w-full h-14 bg-[#bfce7f] text-[#2b3400] font-bold text-[18px] uppercase tracking-wider hover:bg-[#dbea98] transition-all active:scale-[0.98] mt-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
