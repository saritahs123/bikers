...
export default function DepartmentsSecurityView() {
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsSaving(true);
      const res = await fetch(`/api/departamentos/${itemToDelete.id}`, {
        method: 'DELETE'
      });

      if (!res.ok) {
        const errData = await res.json();
        throw new Error(errData.error || "No se pudo eliminar el departamento.");
      }
  ...
  const exportToExcel = () => {
    ...
    showToast("Archivo CSV de Departamentos exportado.");
  };
    ...
    <div className="w-full space-y-6 font-sans text-foreground animate-in fade-in duration-300">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-foreground tracking-tight">Departamentos</h1>
          <p className="text-sm text-foreground-muted mt-1">Gestión administrativa de departamentos y áreas de la organización.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div>
            <p className="font-mono text-[11px] text-foreground-muted uppercase tracking-widest font-bold">Total Departamentos</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-foreground-muted mt-0.5">Visible en catálogos</p>
                    </div>
                  </div>
