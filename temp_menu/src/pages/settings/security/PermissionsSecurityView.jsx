...
export default function PermissionsSecurityView({ onOpenSidebar }) {
  ...
  const apiBase = import.meta.env.VITE_API_URL || (isDevelopment ? 'http://localhost:3000/api' : '/api');
        ...
        <div className="flex items-center gap-2.5 shrink-0 w-full md:w-auto">
          ...
          <button 
            ...
            className={`flex-1 md:flex-initial font-bold text-xs px-4 py-2.5 rounded-xl shadow-sm hover:shadow transition-all flex items-center justify-center gap-2 ${
              saving || loading 
              ? 'bg-rose-400 text-white cursor-not-allowed opacity-70' 
      ...
      <div className="relative flex-1">
        {loading && (
          <div className="absolute inset-0 flex items-center justify-center z-10 bg-[var(--bg-color)]/60 backdrop-blur-sm rounded-2xl">
            <div className="w-8 h-8 border-4 border-rose-500 border-t-transparent rounded-full animate-spin shadow-lg"></div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5 pt-4 border-t border-[var(--border-color)]/50">
              ...
              <input 
                ...
                className="w-full bg-[var(--bg-color)] border border-[var(--border-color)] rounded-lg px-3 py-2 text-xs font-bold text-[var(--text-primary)] focus:outline-none focus:border-rose-500 mt-1"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5 pt-3 border-t border-[var(--border-color)]/50">
              ...
              <select 
                ...
                className="w-full bg-[var(--bg-color)] border border-[var(--border-color)] rounded-lg px-3 py-2 text-xs font-bold text-[var(--text-primary)] focus:outline-none focus:border-rose-500"
              >
            ...
            <div className="flex flex-col gap-3 pt-4 border-t border-[var(--border-color)]/50">
              <label className="flex items-center gap-3 cursor-pointer">
                <input 
                  ...
                  className="rounded border-[var(--border-color)] text-rose-500 focus:ring-rose-500"
                />
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4" style={{ zIndex: 100000 }}>
          ...
          <div className="relative bg-[var(--bg-elevated)] w-full max-w-sm rounded-2xl shadow-2xl p-6 text-center border border-[var(--border-color)] animate-in fade-in zoom-in-95 duration-200">
             ...
             <div className="flex gap-3">
               ...
               <button onClick={handleExecuteReset} disabled={saving} className="flex-1 py-2.5 bg-rose-500 hover:bg-rose-600 active:bg-rose-700 text-white rounded-xl text-sm font-bold shadow-md hover:shadow-lg transition-all disabled:opacity-50">
                 Restablecer
               </button>
             </div>
          </div>
